...
export class Minotaure extends LegendSkills {
  ...
  ultimate(correspSummoners: { emittor: Summoner; receptors: Summoner[] }, skill: Skill): void {
    //  this.skillCalculator.transferStat('def', 'atq', correspSummoners, skill);
  }
  ...
  public castSkill(correspSummoners: { emittor: Summoner; receptors: Summoner[] }, skill: Skill): void {
    switch (skill.number) {
      case 1:
        ...
        // this.skillCalculator.updateAttackWithDefense(correspSummoners.emittor, skill);
        break;
      case 2:
