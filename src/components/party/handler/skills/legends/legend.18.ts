...
export class Jack extends LegendSkills {
  ...
  ultimate(correspSummoners: { emittor: Summoner; receptors: Summoner[] }, skill: Skill): void {
    // if (correspSummoners.emittor.summon.status.stealth) {
  ...
  public castSkill(correspSummoners: { emittor: Summoner; receptors: Summoner[] }, skill: Skill): void {
    switch (skill.number) {
      case 1:
        ...
        break;
      case 2:
        this.skillCalculator.dmgTo(correspSummoners.emittor, correspSummoners.receptors[0], skill, 'stealth');
        break;
      case 3:
