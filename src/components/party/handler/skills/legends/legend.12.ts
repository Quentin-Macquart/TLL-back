...
export class Salem extends LegendSkills {
  ...
  ultimate(correspSummoners: { emittor: Summoner; receptors: Summoner[] }, skill: Skill): void {
    ...
    // Add addtional damage equivalent to 100% of the enemy attack
  }
  ...
  public castSkill(correspSummoners: { emittor: Summoner; receptors: Summoner[] }, skill: Skill): void {
    switch (skill.number) {
      case 1:
        this.skillCalculator.addLegacyEnergy(correspSummoners.emittor, skill);
