...
export class Furiaar extends LegendSkills {
  ...
  public castSkill(
    ...
    switch (skill.number) {
      case 1:
        ...
        break;
      case 2:
        // this.skillCalculator.cleanseStatus(correspSummoners.emittor, skill);
        this.skillCalculator.recoverLP(correspSummoners.emittor, skill);
        break;
      case 3:
        // this.skillCalculator.makeCaseUnselectable(board, caseName);
        break;
      default:
    }
  }
