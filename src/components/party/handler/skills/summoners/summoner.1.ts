import { SummonerSkills } from '@app/components/party/handler';
...
export class Beirn extends SummonerSkills {
  ...
  public castSkill(
    ...
    switch (skill.number) {
      case 1:
        ...
        break;
      case 2:
        // this.skillCalculator.obtainAA(skill.addCost);
        break;
      case 3:
        // this.skillCalculator.consumeTAForAll(2)
        break;
      default:
    }
  }
